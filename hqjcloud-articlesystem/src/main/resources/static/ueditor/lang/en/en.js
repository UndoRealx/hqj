...
UE.I18N['en'] = {
    ...
    'autoupload': {
        ...
        'errorLoadConfig': 'Server com.oauth.server.config not loaded, upload can not work.',
    },
    'simpleupload':{
        'exceedSizeError': 'File Size Exceed',
        'exceedTypeError': 'File Type Not Allow',
    ...
    'loadconfigError': 'Get server com.oauth.server.config error.',
    'loadconfigFormatError': 'Server com.oauth.server.config format error.',
    'loadconfigHttpError': 'Get server com.oauth.server.config http error.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the com.oauth.server.config!",
