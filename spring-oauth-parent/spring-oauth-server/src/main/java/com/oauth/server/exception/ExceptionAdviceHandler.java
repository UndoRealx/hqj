...
import com.oauth.server.dto.response.SimpleResponse;
...
import static com.oauth.server.dto.response.HttpResponse.baseResponse;
import static com.oauth.server.dto.response.HttpResponse.simpleResponse;

/**
 * @ProjectName: hqjcloud
 * @Package: com.oauth.server.exception
 * @ClassName: ExceptionAdviceHandler
 * @Description:
 * @Author: lic
 * @CreateDate: 2019/11/5 11:50
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/11/5 11:50
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
